    ...
    def __init__(self, path_configjson=None):
        ...
        def serialthread():
            while self.serthread_alive:
                ...
                except AnrotFrame_NotCompleted_Exception as NotCompleted:
                    #接收進行中
                    pass
                except AnrotFrame_ErrorFrame_Exception as e:
                    print(e)
                    #目前幀有幀頭，但是為錯誤幀，跳過錯誤幀
